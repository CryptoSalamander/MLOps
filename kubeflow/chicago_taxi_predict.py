...
def catboost_pipeline():
    ...
    classification_model = catboost_train_regression_task.outputs['model']

    evaluation_data_for_regression_in_csv = training_data_in_csv
    evaludation_data_for_classification_in_csv = training_data_for_classification_in_csv
    ...
    catboost_predict_classes_op(
        data=evaludation_data_for_classification_in_csv,
